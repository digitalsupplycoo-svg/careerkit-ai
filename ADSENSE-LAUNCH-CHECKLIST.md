...
- [x] `npm run build` completes with zero errors (see LAUNCH-CHECKLIST.md for the current route count — this file is historical and not kept in sync with every later change).
